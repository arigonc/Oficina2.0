<section class="w-75 mx-auto" style="min-height: 100vh;">
    ...
    <div class="d-block p-5 my-4 bg-white center rounded border">
        ...
        <form action="<?= URL ?>/orcamentos/cadastrar" method="post" autocomplete="off">
            <p class="fs-6 fw-semibold">Dados do orçamento:</p>
            <div class="row">
                <div class="col-md-12 mt-3">
                    <label class="form-label">Cliente<span class="mx-1 text-danger">*</span></label>
                    <input type="text" class="form-control <?= $dados['cliente_erro'] ? "is-invalid" : "" ?>" name="cliente" value="<?= $dados['cliente'] ?>">
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    ...
                    <input type="date" class="form-control <?= $dados['data_orc_erro'] ? "is-invalid" : "" ?>" name="data_orc" value="<?= $dados['data_orc'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['data_orc_erro'] ?>
                    </div>
                </div>
                <div class="col-md-6 mt-3">
                    ...
                    <input type="time" class="form-control <?= $dados['hora_orc_erro'] ? "is-invalid" : "" ?>" name="hora_orc" value="<?= $dados['hora_orc'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['hora_orc_erro'] ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <input type="text" class="form-control <?= $dados['vendedor_erro'] ? "is-invalid" : "" ?>" name="vendedor" value="<?= $dados['vendedor'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['vendedor_erro'] ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <textarea class="form-control <?= $dados['descricao_erro'] ? "is-invalid" : "" ?>" rows="5" name="descricao"><?= $dados['descricao'] ?></textarea>
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control <?= $dados['valor_erro'] ? "is-invalid" : "" ?>" name="valor" value="<?= $dados['valor'] ?>">
                        <div class="invalid-feedback">
                            <?= $dados['valor_erro'] ?>
                        </div>
                    </div>
